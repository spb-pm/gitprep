...
sub change_branch {
  my ( $self, $source_branch, $user, $project ) = @_;
  ...
  open my $fh, "-|", @cmd
    or croak 500, "Cannot change branch";

}

sub merge_branches {
  my ( $self, $source_branch, $target_branch, $user, $project ) = @_;

  $self->change_branch( $source_branch, $user, $project );
  ...
  open my $fh, "-|", @cmd
    or croak 500, "Cannot merge branches";
}
